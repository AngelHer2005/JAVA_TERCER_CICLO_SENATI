...
public class Tarea_13 {
    ...
    public static void main(String[] args) {
        // 11) La tienda CONDESC se dedica a la venta de videos, ingresar el precio , la cantidad de productos comprados,
        // Calcular el total bruto, el descuento del 7% y el total a pagar.
